...
namespace TestIndianStatesCensusAnalyser3
{
    public class Tests
    {
        static string indianStateCensusHeaders = "State,Population,AreaInSqKm,DensityPerSqKm";
        static string indianStateCensusfilePath = @"D:\BridgeLabz-RFP260\IndianStateCensusAnalyserProblem\IndianStatesCensusAnalyserProblem\IndianStatesCensusAnalyserProblem\CSVFiles\IndianStateCensusData.csv";
         static string wrongIndianStateCensusfilePath = @"D:\BridgeLabz-RFP260\IndianStateCensusAnalyserProblem\IndianStatesCensusAnalyserProblem\IndianStatesCensusAnalyserProblem\CSVFiles\IndianCensusData.csv";
        static string wrongIndianStateCensusfileType = @"D:\BridgeLabz-RFP260\IndianStateCensusAnalyserProblem\IndianStatesCensusAnalyserProblem\IndianStatesCensusAnalyserProblem\CSVFiles\IndianStateCensusData.txt";
        static string delimiterIndianCensusfilePath = @"D:\BridgeLabz-RFP260\IndianStateCensusAnalyserProblem\IndianStatesCensusAnalyserProblem\IndianStatesCensusAnalyserProblem\CSVFiles\DelimiterIndianCensusData.csv";
        static string wrongHeaderIndianCensusfilePath = @"D:\BridgeLabz-RFP260\IndianStateCensusAnalyserProblem\IndianStatesCensusAnalyserProblem\IndianStatesCensusAnalyserProblem\CSVFiles\WrongHeaderIndianStateCensusData.csv";

        static string indianStateCodeHeaders = "SrNo,State Name,TIN,StateCode";
        static string indianStateCodefilePath = @"D:\BridgeLabz-RFP260\IndianStateCensusAnalyserProblem\IndianStatesCensusAnalyserProblem\IndianStatesCensusAnalyserProblem\CSVFiles\IndianStateCode.csv";
        static string wrongIndianStateCodefilePath = @"D:\BridgeLabz-RFP260\IndianStateCensusAnalyserProblem\IndianStatesCensusAnalyserProblem\IndianStatesCensusAnalyserProblem\CSVFiles\IndianCode.csv";
        static string wrongIndianStateCodefileType = @"D:\BridgeLabz-RFP260\IndianStateCensusAnalyserProblem\IndianStatesCensusAnalyserProblem\IndianStatesCensusAnalyserProblem\CSVFiles\IndianStateCode.txt";
        static string delimiterIndianCodefilePath = @"D:\BridgeLabz-RFP260\IndianStateCensusAnalyserProblem\IndianStatesCensusAnalyserProblem\IndianStatesCensusAnalyserProblem\CSVFiles\DelimiterIndianStateCode.csv";
        static string wrongHeaderIndianCodefilePath = @"D:\BridgeLabz-RFP260\IndianStateCensusAnalyserProblem\IndianStatesCensusAnalyserProblem\IndianStatesCensusAnalyserProblem\CSVFiles\WrongHeaderIndianStateCode.csv";
